...
cp -a "$ROOT/build/engines/f2" "$PROJECT/app/engines/"
cp -a "$ROOT/build/engines/gallery-dl" "$PROJECT/app/engines/"
cp -a "$ROOT/build/engines/ks-downloader" "$PROJECT/app/engines/"
cp -a "$ROOT/build/engines/xhs-downloader" "$PROJECT/app/engines/"
...
CURRENT_STAGE="record build provenance"
{
  ...
  "$PROJECT/app/engines/f2/f2" --selfcheck || true
  "$PROJECT/app/engines/f2/f2" --version || true
  "$PROJECT/app/engines/gallery-dl/gallery-dl" --version || true
  "$PROJECT/app/engines/ks-downloader/ks-downloader" --selfcheck || true
  "$PROJECT/app/engines/ks-downloader/ks-downloader" --version || true
  "$PROJECT/app/engines/xhs-downloader/xhs-downloader" --selfcheck || true
  "$PROJECT/app/engines/xhs-downloader/xhs-downloader" --version || true
...
for f in \
  ...
  "$INNER/runtime/f2media-runtime/f2media-runtime" "$INNER/engines/f2/f2" "$INNER/engines/gallery-dl/gallery-dl" \
  "$INNER/engines/ks-downloader/ks-downloader" "$INNER/engines/xhs-downloader/xhs-downloader"; do
