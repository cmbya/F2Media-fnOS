...
BUILTINS: list[dict[str, Any]] = [
    ...
    {"key": "facebook-extractor", "label": "Facebook URL Resolver", "kind": "builtin", "recommended": {"facebook"}},
...
DEFAULT_BUILTIN_ORDER = {
    "douyin": ["douyin_parse", "short_videos-local", "gallery-dl", "iiilab", "vidbee", "yt-dlp", "x-cli", "facebook-cli"],
    "kuaishou": ["short_videos-local", "gallery-dl", "yt-dlp"],
    "bilibili": ["yt-dlp"],
    "xiaohongshu": ["gallery-dl", "yt-dlp"],
    "instagram": ["gallery-dl", "iiilab", "vidbee", "yt-dlp"],
    "twitter": ["x-cli", "gallery-dl", "yt-dlp", "iiilab", "vidbee"],
    "youtube": ["yt-dlp", "iiilab", "vidbee"],
    "facebook": ["facebook-extractor", "vidbee", "iiilab", "fdownloader", "gallery-dl", "yt-dlp", "facebook-cli"],
