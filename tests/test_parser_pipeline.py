...
def test_video_backup_is_not_counted_as_second_content_video():
    result = normalize_external_result({
        'data': {'type': 'video', 'title': '快手测试', 'url': 'https://cdn.example.com/main.mp4',
                 'video_backup': ['https://cdn.example.com/backup1.mp4']}
...
def test_xhs_captcha_redirect_path_recovers_note_url():
    wrapped = 'https://www.xiaohongshu.com/website-login/captcha?redirectPath=https%3A%2F%2Fwww.xiaohongshu.com%2Fdiscovery%2Fitem%2F6a6c647d0000000006006316%3Fxsec_token%3Dabc'
...
def test_pipeline_order_is_user_configurable():
    ...
    assert DEFAULT_BUILTIN_ORDER["facebook"][:4] == ["facebook-resolver", "gallery-dl", "facebook-cli", "yt-dlp"]
